...
import com.htc.smoonos.adapter.AccoutsManagerAdapter;
import com.htc.smoonos.databinding.ActivityAccountBinding;
import com.htc.smoonos.widget.AccountSyncDialog;
import com.htc.smoonos.widget.SpacesItemDecoration;

import java.util.ArrayList;
import java.util.List;

public class AccountActivity extends BaseActivity implements AccountSyncDialog.AccountCallBack, View.OnKeyListener {
    ...
    private void initView() {
        ...
        accountBinding.rlAccountAdd.setOnKeyListener(this);
...
//                intent.putExtra(EXTRA_AUTHORITIES, mAuthorities);
    ...
    public boolean onKey(View v, int keyCode, KeyEvent event) {
        int id = v.getId();
        if ((id == R.id.rl_account_add) && keyCode == KeyEvent.KEYCODE_DPAD_DOWN) {
            Log.d(TAG, " keCode " + keyCode + " " + event.getEventTime());
            if ((accountBinding.rlAccountAdd.hasFocus()) && event.getAction() == KeyEvent.ACTION_DOWN) {
