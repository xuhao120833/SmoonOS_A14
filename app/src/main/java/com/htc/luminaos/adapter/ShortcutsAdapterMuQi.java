 ...
 * Description:
 */
public class ShortcutsAdapterMuQi extends RecyclerView.Adapter<ShortcutsAdapterMuQi.MyViewHolder> implements View.OnFocusChangeListener {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        MyViewHolder myViewHolder = new MyViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.shortcuts_item_muqi, null));
        return myViewHolder;
    }
